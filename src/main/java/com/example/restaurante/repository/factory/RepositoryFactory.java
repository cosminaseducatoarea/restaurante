...
public class RepositoryFactory {
    ...
    private static Repository<Integer, Table> createTablesRepository() {
        return new TablesDbRepository("jdbc:postgresql://localhost:5433/restaurants1",
                    "postgres", "postgres");
    }

    private static Repository<Integer, Order> createOrdersRepository() {
            return new OrdersDbRepository("jdbc:postgresql://localhost:5433/restaurants1",
                    "postgres", "postgres");
    }

    private static Repository<Integer, MenuItem> createMenuItemsRepository() {
        return new MenuItemsDbRepository("jdbc:postgresql://localhost:5433/restaurants1",
                "postgres", "postgres");
    }
